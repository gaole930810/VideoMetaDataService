...
/**
 * 这个方法用原始的解码帧方法从第一帧开始读取知道第n帧。
 *
 */
public class LocalVideo_ReadSingleFrame {
    public static final Log LOG = LogFactory.getLog(LocalVideo_ReadSingleFrame.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        while(container.readNextPacket(packet) >= 0){
        	System.out.println("firstwhile:"+firstwhile++);
            if(packet.getStreamIndex() == VideoStreamIndex){
                ...
                while(offset < packet.getSize()){
                	System.out.println("secondwhile:"+secondwhile++);
