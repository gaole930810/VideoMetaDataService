...
public class Experiment20 {
    public static final Log LOG = LogFactory.getLog(Experiment20.class);
    ...
    public static void main(String[] args) throws IOException {
      ...
      //创建一个Container来打开视频，如果path是hdfs的路径，则使用HDFSProtocolHandler
        ...
        int sizePerTime=1;
            ...
            fw = new FileWriter("/home/b8311/Experiment/ExperimentResult/"+"Experiment20-"+new Path(Path).getName() + ".txt",true);
            for(int k=0;k<30;k++){
