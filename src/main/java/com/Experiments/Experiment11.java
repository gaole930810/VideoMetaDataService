...
public class Experiment11 {
    public static final Log LOG = LogFactory.getLog(Experiment11.class);
    ...
    public static void main(String[] args) throws IOException {
      ...
      //创建一个Container来打开视频，如果path是hdfs的路径，则使用HDFSProtocolHandler
        ...
        for(int j=0;j<5;j++){
            ...
            fw = new FileWriter("/home/b8311/Experiment/ExperimentResult/"+"Experiment11-"+new Path(Path).getName() + ".txt",true);
            for(int k=0;k<10;k++){
